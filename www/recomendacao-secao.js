...
const styles = `
  ...
  #ag-drawer.open {
   ...
   .ag-drawer-scroll {
    ...
    max-height: 85vh;
    overflow-y: auto;
    padding: 0 14px 21px 14px; /* Removido padding-top (de 21px para 0) */
  ...
  .ag-drawer-header {
    ...
    max-width: 840px;
    position: sticky;
    top: 0; /* Colado no topo real */
    z-index: 100;
    margin: 0 auto 21px auto; /* Removida margem negativa que causava deslocamento */
    padding: 5px 0; /* Padding mínimo para não encostar na borda física */
